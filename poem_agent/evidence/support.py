...
from ..contracts import AnalysisSupport, EvidenceItem
...
def force_fallback_analysis_support() -> AnalysisSupport:
    return {
        "level": "insufficient",
        "target_ids": [],
...
def _valid_evidence_poem_ids(evidence: list[EvidenceItem]) -> list[str]:
    poem_ids: list[str] = []
